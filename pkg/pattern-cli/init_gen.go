...
func RegisterGeneratedCommands(fm dsl.FuncMap) {
	...
	fm["mud_tracks"] = func(args []string, input image.Image) (image.Image, error) {
		if len(args) < 1 {
			return nil, fmt.Errorf("mud_tracks requires 1 arguments")
		}
		return nil, fmt.Errorf("command mud_tracks has unsupported argument types")
	}
