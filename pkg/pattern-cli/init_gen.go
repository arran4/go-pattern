...
func RegisterGeneratedCommands(fm dsl.FuncMap) {
	...
	fm["frost_cracks"] = func(args []string, input image.Image) (image.Image, error) {
		if len(args) < 0 {
			return nil, fmt.Errorf("frost_cracks requires 0 arguments")
		}
		return pattern.NewFrostCracks(), nil
	}
