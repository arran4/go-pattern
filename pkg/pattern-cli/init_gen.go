...
func RegisterGeneratedCommands(fm dsl.FuncMap) {
	...
	fm["warm_fibers_gradient"] = func(args []string, input image.Image) (image.Image, error) {
		if len(args) < 0 {
			return nil, fmt.Errorf("warm_fibers_gradient requires 0 arguments")
		}
		return pattern.NewWarmFibersGradient(), nil
	}
